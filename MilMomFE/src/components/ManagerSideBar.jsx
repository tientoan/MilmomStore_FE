...
import { blankAvatar, emptyAvatar, sideBarAdminData, sideBarManagerData, sideBarStaffData } from "../data/data";
  ...
  return (
    ...
    <div className=" rounded-lg pt-5 min-h-screen bg-red-100 px-1">
     <div className="flex items-center my-20">
      ...
      <div className="text-blue-950 font-bold text-xl">Manager</div>
     </div>
      {sideBarManagerData.map((data) => (
